...
public class JobServiceTest {
    ...
    private static JobServiceTest instance;

    public static JobServiceTest createDemoService() {
        if (instance == null) {

            final JobServiceTest contactService = new JobServiceTest();
            ...
            for (int i = 0; i < 100; i++) {
                ...
                contact.setJobMacro(fnames[r.nextInt(fnames.length)]);
